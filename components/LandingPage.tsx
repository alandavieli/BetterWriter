            ...
            <nav className="fixed w-full z-50 bg-cream-50/90 dark:bg-neutral-900/90 backdrop-blur-md border-b border-gold-200/30 dark:border-white/5 transition-all">
                <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <Button size="md" onClick={() => setShowAuthModal(true)} className="rounded-2xl px-6">
                            Sign In
                        </Button>
                    </div>
                </div>
            ...
            <header className="pt-40 pb-32 px-6 relative flex flex-col items-center justify-center text-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <Button size="lg" className="h-14 px-10 text-lg rounded-2xl shadow-gold-500/25 shadow-xl hover:shadow-2xl hover:shadow-gold-500/30 transform hover:-translate-y-1 transition-all" onClick={() => setShowAuthModal(true)}>
                            Start Writing Free
                        </Button>
